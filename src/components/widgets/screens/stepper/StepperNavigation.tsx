...
export function StepperNavigation({
  ...
  return <div className="border-t border-gray-800 p-4 flex justify-between">
      {!showOnlyUpdateFramework && <Button onClick={onPrevious} disabled={isPreviousDisabled} className="bg-gray-800 hover:bg-gray-700 text-white">
          Previous
        </Button>}
      ...
      <div className={`flex gap-2 ${showOnlyUpdateFramework ? 'w-full justify-center' : ''}`}>
        ...
        {!showOnlyUpdateFramework && currentStep < totalSteps && <Button onClick={onNext} disabled={isLoading || isNextDisabled} className="bg-blue-600 hover:bg-blue-500 text-white">
